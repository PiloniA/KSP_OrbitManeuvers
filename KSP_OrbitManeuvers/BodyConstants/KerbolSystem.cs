namespace KSP_OrbitManeuvers.BodyConstants
{
    public class KerbolSystem : DummySystem
    {
        ...
        public const float Moho_Density = 234.23818F;
        public const float Moho_EscapeVelocity = 94672.01F;
        public const float Moho_SiderealRotationPeriod = 432000F;
        public const float Moho_SphereOfInfluence = float.PositiveInfinity;

        public const bool Moho_AtmospherePresent = true;
        public const float Moho_AtmosphericPressure = 16F;
        public const float Moho_AtmosphericHeight = 600000;
        public const float Moho_TemperatureMin = 4014.95F;
        public const float Moho_TemperatureMax = 9621.2F;
